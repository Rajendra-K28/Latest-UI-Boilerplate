...
export function EvidenceDetailsView({
  ...
  const dummyComments: ActivityItem[] = [
    {
      ...
      user: 'John Smith',
      userInitials: 'JS',
      text: 'Please review the latest configuration updates. We need approval by end of week.',
      timestamp: '16 Jan 2025, 10:30 AM',
    },
    {
      id: 'c2',
      type: 'comment',
      user: 'Sarah Johnson',
      userInitials: 'SJ',
      text: 'I have reviewed the document and it looks good. Just one minor comment on section 3.',
      timestamp: '15 Jan 2025, 3:45 PM',
    },
  ];
  ...
  const dummyActivities: ActivityItem[] = [
    ...
    },
    {
      ...
      user: 'Rajeev R',
      userInitials: 'RR',
      text: 'assigned the evidence to Anita R',
      timestamp: '15 Jan 2025, 9:01 AM',
    },
    {
      id: 'a3',
      type: 'activity',
      user: 'Rajeev R',
      userInitials: 'RR',
      text: 'created the evidence',
      timestamp: '15 Jan 2025, 9:00 AM',
    },
  ];
    ...
    <>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.headerLeft}>
          ...
          <span style={styles.headerTitle}>Evidence details</span>
        </div>
        <button
          type="button"
